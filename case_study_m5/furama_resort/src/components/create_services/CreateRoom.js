...
function CreateRoom() {
    ...
    const validateObject = {
        ...
        freeFacilities: Yup.string().required("Vui lòng nhập mô tả các tiện ích khác!"),
        rentalPeriod: Yup.string().required("Vui lòng nhập thời gian thuê!"),
    };


    const addNewRoom = async (values) => {
        let result = await services.createRoom(values);
        if (result) {
            ...
            <div id="board">
                <Form className="mx-4" method="post" id="submit-form">
                    ...
                    <div id="date" className="div-element in-one-line">
                        ...
                        <div>
                            <label htmlFor="capability" className="form-label">Sức chứa :</label>
                    ...
                    <div id="employeeInf" className="div-element in-one-line">
                        ...
                        <div>
                            <label htmlFor="freeFacilities" className="form-label">Dịch vụ miễn phí đi kèm:</label>
                            <Field type="text" className="form-control extra-service" name="freeFacilities" id="freeFacilities"/>
                            <ErrorMessage name="freeFacilities" component="span" className="err-mess text-danger"/>
